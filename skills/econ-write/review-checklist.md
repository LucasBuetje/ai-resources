...
**Word choice red flags**: the banned words listed in SKILL.md's "Avoiding AI-Generated Writing Patterns" section — that list is canonical; edit it only there so drafting and reviewing use the same filter.
